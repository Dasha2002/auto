    ...
    <div class="header-fixed__inner">
      ...
      <div class="header-actions">
          <div class="header-socials">
            <a href="tel:88005508654" class="header-phone__number">8 800 550 86 54</a>
            <div class="header-socials__icons">
              <a href="" class="header-socials__icon">
                <img src="../../assets/max-icon.png"/>
              </a>
              <a href="https://t.me/mustaione" class="header-socials__icon">
                <img src="../../assets/tg-icon.png"/>
              </a>
            </div>
          </div>
          <!-- <span class="header-phone__text">Звонок бесплатный</span> -->
        <button type="button" class="btn btn-header btn--primary btn--sm open-modal btn-popap" data-modal-target="callback-modal">
          ОБРАТНЫЙ ЗВОНОК
        </button>
        <!-- Кнопка гамбургера -->
        <button type="button" 
    ...
    <div class="mobile-menu__content">
      ...
      <footer class="mobile-menu__footer">
        <div class="mobile-social">
          ...
          <a href="https://max.ru/u/f9LHodD0cOKaQvKLu1BgvEu8wb6SRr8w5pM1QzDDOsm0kY-oirjh35SuYeg" class="mobile-social__link" aria-label="WhatsApp" target="_blank">
            <div class="max-icon-wrapper">
              <img src="../../assets/max-icon-png.png" class="max-icon" alt="MAX" width="25" height="25" >
            </div>
          </a>
        </div>
