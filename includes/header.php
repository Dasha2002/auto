    ...
    <div class="mobile-menu__content">
      ...
      <footer class="mobile-menu__footer">
        <div class="mobile-social">
          <a href="#" class="mobile-social__link" aria-label="ВКонтакте">
          ...
          <a href="#" class="mobile-social__link" aria-label="YouTube">
          ...
          <a href="#" class="mobile-social__link" aria-label="Telegram">
          ...
          <a href="#" class="mobile-social__link" aria-label="WhatsApp">
